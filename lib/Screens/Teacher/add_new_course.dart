...
import 'package:final_cv/Datasource/images_data.dart';
...
class _AddNewCourseState extends State<AddNewCourse> {
    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Theme.of(context)
            .primaryColor, // Ensures use of the theme's primary color
        title: const Text(
          'Create Course',
          style: TextStyle(
            fontSize: 25, // Increase font size for better visibility
            fontWeight:
                FontWeight.bold, // Added font weight for better readability
          ),
        ),
        elevation: 4.0,
      ),
          ...
          children: <Widget>[
            ...
            Column(
              mainAxisAlignment: MainAxisAlignment
                  .spaceEvenly, // Use spaceEvenly for better distribution
              children: [
                Padding(
  ...
  Widget _buildTextField(
      {required String label, required void Function(String) onChanged}) {
    return Padding(
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          ...
          padding: const EdgeInsets.symmetric(
              horizontal: 20, vertical: 10), // Better padding for aesthetics
        ),
        child: const Text(
          'Save',
          style: TextStyle(
